...
const colors = {
  ...
  CODEMIRROR_TOKENS: {
    DEFINITION: '#8ba4b0', // function - matches Helix treesitter function color (blue/cyan)
    PROPERTY: '#8ba4b0', // property - matches Helix treesitter property color
    STRING: '#87a987', // string - matches Helix treesitter string color (green)
    NUMBER: '#c4b28a', // number - matches Helix treesitter number color (yellow)
    ATOM: '#c4b28a', // type - matches Helix treesitter type color (yellow)
    VARIABLE: '#c5c9c5', // variable - matches Helix treesitter variable color (text)
    KEYWORD: '#c4746e', // keyword - matches Helix treesitter keyword color (red)
    COMMENT: '#737c73', // comment - matches Helix treesitter comment color (muted)
    OPERATOR: '#c5c9c5', // operator - matches Helix treesitter operator color (text)
    TAG: '#8ba4b0', // tag - matches Helix treesitter tag color (blue/cyan)
    TAG_BRACKET: '#737c73' // tag bracket - matches Helix treesitter bracket color (muted)
  }
};
...
export default kanagawadragonTheme;
