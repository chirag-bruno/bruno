...
const colors = {
  ...
  CODEMIRROR_TOKENS: {
    DEFINITION: '#bee0ec', // function - matches Helix treesitter function color (blue/cyan)
    PROPERTY: '#bee0ec', // property - matches Helix treesitter property color
    STRING: '#10b981', // string - matches Helix treesitter string color (green)
    NUMBER: '#ffcd1c', // number - matches Helix treesitter number color (yellow)
    ATOM: '#ffcd1c', // type - matches Helix treesitter type color (yellow)
    VARIABLE: '#bfdbfe', // variable - matches Helix treesitter variable color (text)
    KEYWORD: '#f43f5e', // keyword - matches Helix treesitter keyword color (red)
    COMMENT: '#484a4d', // comment - matches Helix treesitter comment color (muted)
    OPERATOR: '#bfdbfe', // operator - matches Helix treesitter operator color (text)
    TAG: '#bee0ec', // tag - matches Helix treesitter tag color (blue/cyan)
    TAG_BRACKET: '#484a4d' // tag bracket - matches Helix treesitter bracket color (muted)
  }
};
