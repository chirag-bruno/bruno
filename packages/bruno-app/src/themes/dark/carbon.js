...
const colors = {
  ...
  CODEMIRROR_TOKENS: {
    DEFINITION: '#4589ff', // function - matches Helix treesitter function color (blue)
    PROPERTY: '#4589ff', // property - matches Helix treesitter property color
    STRING: '#42be65', // string - matches Helix treesitter string color (green)
    NUMBER: '#f1c21b', // number - matches Helix treesitter number color (yellow)
    ATOM: '#f1c21b', // type - matches Helix treesitter type color (yellow)
    VARIABLE: '#a8a8a8', // variable - matches Helix treesitter variable color (text)
    KEYWORD: '#ff8389', // keyword - matches Helix treesitter keyword color (red)
    COMMENT: '#6F6F6F', // comment - matches Helix treesitter comment color (muted)
    OPERATOR: '#a8a8a8', // operator - matches Helix treesitter operator color (text)
    TAG: '#4589ff', // tag - matches Helix treesitter tag color (blue)
    TAG_BRACKET: '#6F6F6F' // tag bracket - matches Helix treesitter bracket color (muted)
  }
};
