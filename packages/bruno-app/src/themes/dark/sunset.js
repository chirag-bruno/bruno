...
const colors = {
  ...
  CODEMIRROR_TOKENS: {
    DEFINITION: '#77AAAA', // function - matches Helix treesitter function color (blue/cyan)
    PROPERTY: '#77AAAA', // property - matches Helix treesitter property color
    STRING: '#66CC33', // string - matches Helix treesitter string color (green)
    NUMBER: '#EEEE11', // number - matches Helix treesitter number color (yellow)
    ATOM: '#EEEE11', // type - matches Helix treesitter type color (yellow)
    VARIABLE: '#EEEEEE', // variable - matches Helix treesitter variable color (text)
    KEYWORD: '#EE1111', // keyword - matches Helix treesitter keyword color (red)
    COMMENT: '#777777', // comment - matches Helix treesitter comment color (muted)
    OPERATOR: '#EEEEEE', // operator - matches Helix treesitter operator color (text)
    TAG: '#77AAAA', // tag - matches Helix treesitter tag color (blue/cyan)
    TAG_BRACKET: '#777777' // tag bracket - matches Helix treesitter bracket color (muted)
  }
};
