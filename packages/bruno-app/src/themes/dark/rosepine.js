...
const colors = {
  ...
  CODEMIRROR_TOKENS: {
    DEFINITION: '#9ccfd8', // function - matches Helix treesitter function color (blue/cyan)
    PROPERTY: '#9ccfd8', // property - matches Helix treesitter property color
    STRING: '#31748f', // string - matches Helix treesitter string color (green/teal)
    NUMBER: '#f6c177', // number - matches Helix treesitter number color (yellow)
    ATOM: '#f6c177', // type - matches Helix treesitter type color (yellow)
    VARIABLE: '#e0def4', // variable - matches Helix treesitter variable color (text)
    KEYWORD: '#eb6f92', // keyword - matches Helix treesitter keyword color (red)
    COMMENT: '#6e6a86', // comment - matches Helix treesitter comment color (muted)
    OPERATOR: '#e0def4', // operator - matches Helix treesitter operator color (text)
    TAG: '#9ccfd8', // tag - matches Helix treesitter tag color (blue/cyan)
    TAG_BRACKET: '#6e6a86' // tag bracket - matches Helix treesitter bracket color (muted)
  }
};
