...
const colors = {
  ...
  CODEMIRROR_TOKENS: {
    DEFINITION: '#519FDF', // function - matches Helix treesitter function color (blue)
    PROPERTY: '#519FDF', // property - matches Helix treesitter property color
    STRING: '#7DA869', // string - matches Helix treesitter string color (green)
    NUMBER: '#D5B06B', // number - matches Helix treesitter number color (yellow)
    ATOM: '#D5B06B', // type - matches Helix treesitter type color (yellow)
    VARIABLE: '#ABB2BF', // variable - matches Helix treesitter variable color (text)
    KEYWORD: '#D05C65', // keyword - matches Helix treesitter keyword color (red)
    COMMENT: '#636C6E', // comment - matches Helix treesitter comment color (muted)
    OPERATOR: '#ABB2BF', // operator - matches Helix treesitter operator color (text)
    TAG: '#519FDF', // tag - matches Helix treesitter tag color (blue)
    TAG_BRACKET: '#636C6E' // tag bracket - matches Helix treesitter bracket color (muted)
  }
};

const onedarkerTheme = {
  mode: 'dark',
  brand: colors.BRAND,
  text: colors.TEXT,
