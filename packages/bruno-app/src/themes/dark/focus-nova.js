...
const colors = {
  ...
  CODEMIRROR_TOKENS: {
    DEFINITION: '#89b4fa', // function - matches Helix treesitter function color (blue)
    PROPERTY: '#89b4fa', // property - matches Helix treesitter property color
    STRING: '#c0fca0', // string - matches Helix treesitter string color (green)
    NUMBER: '#f9e2af', // number - matches Helix treesitter number color (yellow)
    ATOM: '#f9e2af', // type - matches Helix treesitter type color (yellow)
    VARIABLE: '#dcdcdc', // variable - matches Helix treesitter variable color (text)
    KEYWORD: '#ff6e7f', // keyword - matches Helix treesitter keyword color (red)
    COMMENT: '#7a7a89', // comment - matches Helix treesitter comment color (muted)
    OPERATOR: '#dcdcdc', // operator - matches Helix treesitter operator color (text)
    TAG: '#89b4fa', // tag - matches Helix treesitter tag color (blue)
    TAG_BRACKET: '#7a7a89' // tag bracket - matches Helix treesitter bracket color (muted)
  }
};

const focusnovaTheme = {
  mode: 'dark',
  brand: colors.BRAND,
  text: colors.TEXT,
