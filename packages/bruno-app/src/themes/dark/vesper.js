...
const colors = {
  ...
  CODEMIRROR_TOKENS: {
    DEFINITION: '#ffc799', // function - matches Helix treesitter function color (blue/orange)
    PROPERTY: '#ffc799', // property - matches Helix treesitter property color
    STRING: '#99FFE4', // string - matches Helix treesitter string color (green/cyan)
    NUMBER: '#ffc799', // number - matches Helix treesitter number color (yellow/orange)
    ATOM: '#ffc799', // type - matches Helix treesitter type color (yellow/orange)
    VARIABLE: '#ffffff', // variable - matches Helix treesitter variable color (text)
    KEYWORD: '#ff8080', // keyword - matches Helix treesitter keyword color (red)
    COMMENT: '#8b8b8b', // comment - matches Helix treesitter comment color (muted)
    OPERATOR: '#ffffff', // operator - matches Helix treesitter operator color (text)
    TAG: '#ffc799', // tag - matches Helix treesitter tag color (blue/orange)
    TAG_BRACKET: '#8b8b8b' // tag bracket - matches Helix treesitter bracket color (muted)
  }
};
