...
const colors = {
  ...
  CODEMIRROR_TOKENS: {
    DEFINITION: '#67b0e8', // function - matches Helix treesitter function color (blue)
    PROPERTY: '#67b0e8', // property - matches Helix treesitter property color
    STRING: '#8ccf7e', // string - matches Helix treesitter string color (green)
    NUMBER: '#e5c76b', // number - matches Helix treesitter number color (yellow)
    ATOM: '#e5c76b', // type - matches Helix treesitter type color (yellow)
    VARIABLE: '#dadada', // variable - matches Helix treesitter variable color (text)
    KEYWORD: '#e57474', // keyword - matches Helix treesitter keyword color (red)
    COMMENT: '#404749', // comment - matches Helix treesitter comment color (muted)
    OPERATOR: '#dadada', // operator - matches Helix treesitter operator color (text)
    TAG: '#67b0e8', // tag - matches Helix treesitter tag color (blue)
    TAG_BRACKET: '#404749' // tag bracket - matches Helix treesitter bracket color (muted)
  }
};

const everblushTheme = {
  mode: 'dark',
  brand: colors.BRAND,
  text: colors.TEXT,
