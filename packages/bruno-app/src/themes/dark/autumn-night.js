...
const colors = {
  ...
  CODEMIRROR_TOKENS: {
    DEFINITION: '#72a59e', // function - matches Helix treesitter function color (turquoise/blue)
    PROPERTY: '#72a59e', // property - matches Helix treesitter property color
    ...
    COMMENT: '#626C66', // comment - matches Helix treesitter comment color (muted)
    OPERATOR: '#F3F2CC', // operator - matches Helix treesitter operator color (text)
    TAG: '#72a59e', // tag - matches Helix treesitter tag color (blue/cyan)
    TAG_BRACKET: '#626C66' // tag bracket - matches Helix treesitter bracket color (muted)
  }
};

const autumnnightTheme = {
  mode: 'dark',
  brand: colors.BRAND,
  text: colors.TEXT,
...
export default autumnnightTheme;
